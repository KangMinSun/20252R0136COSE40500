...
export function IconDanger({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconLoading({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconZoomIn({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconZoomOut({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
